...
extern void test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndsbarbottomisTrue(void);
...
int main(void)
{
  ...
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndsbarbottomisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndsbarbottomisTrue", 181);
