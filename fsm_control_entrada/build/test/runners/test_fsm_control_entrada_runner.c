...
int main(void)
{
  ...
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenUPAndDeadlineisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenUPAndDeadlineisTrue", 114);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenUPAndDeadlineisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenUPAndDeadlineisFalse", 130);
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenUPAndSProxisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenUPAndSProxisTrue", 147);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenUPAndSProxisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenUPAndSProxisFalse", 164);
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndBarBottomisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndBarBottomisTrue", 180);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenBajandoAndBarBottomisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenBajandoAndBarBottomisFalse", 194);
