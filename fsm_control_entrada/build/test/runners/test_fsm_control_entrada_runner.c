...
int main(void)
{
  ...
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenWaitingAndDeadlineisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenWaitingAndDeadlineisTrue", 207);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenWaitingAndDeadlineisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenWaitingAndDeadlineisFalse", 223);
