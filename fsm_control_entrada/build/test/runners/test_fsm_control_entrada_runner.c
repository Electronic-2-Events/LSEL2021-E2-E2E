...
int main(void)
{
  ...
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndbarbottomisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndbarbottomisTrue", 181);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenBajandoAndsbarbottomisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenBajandoAndsbarbottomisFalse", 196);
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenWaitingAndDeadlineisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenWaitingAndDeadlineisTrue", 215);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenWaitingAndDeadlineisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenWaitingAndDeadlineisFalse", 231);
