...
int main(void)
{
  ...
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndbarbottomisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenBajandoAndbarbottomisTrue", 177);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenBajandoAndsbarbottomisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenBajandoAndsbarbottomisFalse", 192);
  run_test(test_fsm_control_entrada_fsmFireFollowTransitionWhenWaitingAndDeadlineisTrue, "test_fsm_control_entrada_fsmFireFollowTransitionWhenWaitingAndDeadlineisTrue", 209);
  run_test(test_fsm_control_entrada_fsmFireDontFollowTransitionWhenWaitingAndDeadlineisFalse, "test_fsm_control_entrada_fsmFireDontFollowTransitionWhenWaitingAndDeadlineisFalse", 225);
